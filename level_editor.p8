...
function draw_map_miniview()
	...
	for j=max(y_off\mm_scale,12),min((y_off+128)\mm_scale-1,43) do
	...
	local function rectmap(x1,y1,x2,y2,col)
				rect(x1*mm_scale,y1*mm_scale,x2*mm_scale,y2*mm_scale,col)
	end
	
	if not skip_borders then
		for i=1, #lvls_info do
			local lvl_info = split(lvls_info[i],"`")
...
function _update_m_menu()
	...
	cursor_pos = ((cursor_pos-1)%#lvls_info)+1
	if btnp(4) then
		load_l_editor()
	end
end
...
function draw_cursor()
	circ(mous_x, mous_y,1,5)
	circ(mous_x, mous_y,0,7)
...
function load_level(index)
	...
	loaded_level_info = split(lvls_info[index],"`")
...
function _draw_l_settings()
	...
	for i=1, 17 do
		...
		elseif i==14 or i==15 then
			...
			dat_str = dat_str .. "\f" .. p_col .. " (" .. (mempos-4096)%128 .. "x " .. (mempos-4096)\128+32 .. "y)"
	...
	elseif l_set_cursor_pos == 19 then
		...
		local bg_sampl = {}
		for i=0, 15 do
			add(bg_sampl, @(7936 + lvl_bg1[2]*4 + i%4))
		end
		pal(bg_sampl)
	...
	elseif l_set_cursor_pos == 29 then
		...
		local bg_sampl = {}
		for i=0, 15 do
			add(bg_sampl, @(7936 + lvl_bg2[2]*4 + i%4))
		end
		pal(bg_sampl)
...
-- extra modifications for entities in a level. 
-- have some control codes, so after edits this should be compressed in the level editor (compress extras option in main menu pause)
-- and then pasted in the next tab, replacing ntt_extras
...
-- all the level headers
lvls_info = split([[   the construction site  `2`24`24`lly/-32`56`14`23`3`6`1`0`1`1`4`11904`5
...
-- starting menu index, & levels present in the menu
...
-- modifications for certain entities in level, no newlines to keep control chars
-- can be edited in a more readable format in the previous tab, then compressed and pasted here
...
-- property modifications guns can apply
prop_mods = split([[/
rngf,rngn/90,45
...

...

