...
function _draw_l_settings()
	...
	elseif l_set_cursor_pos == 19 then
		...
		local bg_sampl = {}
		for i=0, 15 do
			add(bg_sampl, @(4480 + lvl_bg1[2]*4 + i%4))
		end
		pal(bg_sampl)
	...
	elseif l_set_cursor_pos == 29 then
		...
		local bg_sampl = {}
		for i=0, 15 do
			add(bg_sampl, @(4480 + lvl_bg2[2]*4 + i%4))
		end
		pal(bg_sampl)
...
rX,rY/0,-20
rX,rY/-16,-16
Btyp,permastick,rope,ai_a,rngN,rngF/5,true,nil,_V_AIAfllw,35,70
gunid/9
boss/true
rope,rX,rY/1,76,-20
b_f/_V_d_load_next
...
txtB/\f3looks like⬇️false⬇️90⬇️102⬇️98⬇️32⬇️8⬇️1
