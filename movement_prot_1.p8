...
function draw_entity(entity)
	...
	if entity.sprite then
		spr(entity.sprite, ep.x-4, ep.y-4,1,1, entity.is_left)
	--else
...
function draw_enm(enm)
	...
	if enm.active or hurt then
		...
		spr_outl(enm.sprite, e_spr_x, e_spr_y,enm_col,enm.is_left)
	end
...
function draw_joint(p1,p2,rds,col,is_left)
	if p1 != p2 then
...
function move_control(ntt, b4, b5)
	...
	if b4 and (jump_g or jump_s) and jump_cooldown <= 0 then
		...
		ntt.vel, pv_1, pv_2 = recomp_mul(ntt.vel, input_dir_j2, 0.9, 0.6)
		-- add less if already going fast
		-- todo add special case for bouncy materials
		local jump_str = max(0.1, ntt.jump_str - (vec2_len(pv_1)/ntt.jump_str*1.1)^2)
		...
		if ntt.grounded_mode and ntt.ground_is_entity and 
 ...
 local align_down=v2c(vec2_down)
	...
	ntt.facing = vec2_normalized(input_dir_j*0.4 - ntt.leg_facing + vec2_up*0.6)
...
{split"1-1, 3, 10,180, 60,80",{},{}},
{split"1-2, 4, 10,50, 60,80",{},{}},
{split"1-3, 5, 10,180, 60,80",{},{}},
...
palettes = split[[
	...
	142,15,0,  130,2,6,7,   2,8,9,10,   7,12,10,13, 143,
...
__gfx__

...
44444444444444444554455455555555baa9baa9aaa99999bbbbbaababbbbbaababbbbba44444444ba9cba9b554555454442244405020f002222222122222121
...

...
5554555455545554554455445555555599999999999999999999999999999999aa888a8899999999ba9bba9b55455445554225540f000f002211111251111115
...

...

...

...

__sfx__
