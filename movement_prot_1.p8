...
function _update()
 ...
 --then the first moved entity would pull the other much more
	...
	-- camera tracking
	local follow_pos=player.pos+player.vel*20 + vec2_normalized(player.prev_input_dir + vec2_right*(tonum(player.is_right)*2-1))*30
...
function remove_listed_entity(e, explode)
	...
	if explode then
		sfx(16)
		for i=1, 5 do
			delay_timer(delay_timers_draw, 1, particle_delay, {v2c(e.pos), vec2_new(rnd(3)-1.5,rnd(3)-1.5) + e.vel, 3.5, e.col or 7})
		end
	end
...

...

