		...
		for i=1, #entity.l_target_groups do
			...
			for j=1, #entity.l_target_groups[i] do
				...
				if did then
					...
					local dist = vec2_len(entity.l_target_groups[i][j].pos - stand_centers[j])
