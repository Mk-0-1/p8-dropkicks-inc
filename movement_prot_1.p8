...
function spawn_player(px,py)
 ...
 local player_l = spawn_complex(px,py,ntt_b_types[1],{80,40},0b00000010,0b00001101)
	...
	mod_tabl2(player_l,"col,update_func,draw_func",{13,update_player,draw_humanoid})
...
function draw_entity(entity)
	...
	if entity.sprite then
		spr(entity.sprite, entity.pos.x-4, entity.pos.y-4,1,1, entity.is_left)
	--else
...
function draw_humanoid(ntt)
	...
	local e_pos_y = head_pos_sprite.y
	...
	if anim_c%(55) > 3 or vec2_len(ntt.vel) > 0.5 then
		spr(144+spr_i, head_pos_sprite.x, e_pos_y,1,1,flip_r,flip_u)
	end
...
function tile_to_entity(tile_pos, convert)
	...
	mod_tabl2(t_e,"sprite,e_type,stmn,stmn_l_b",{t_dat,"tile",t_stmn,0})
...
function move_control(ntt, b4, b5)
	...
	if b4 and (jump_g or jump_s) and jump_cooldown <= 0 then
		...
		local jump_str, slowdown = ntt.jump_str,0.6
...

