...
function _update_inlvl()
	...
	if player.pos.x > x_l_l+12 and btn(1) and lvl_next_level > -2 and lvl_e_c >= e_rq then
		if lvl_next_level > 0 then
			scrW(24,8,load_next)
		else 
			load_next()
...
function _draw_inlvl()
	...
	if lvl_next_level > -2 then
		...
		if lvl_e_c < e_rq then
			c = 3
			txtB("\^o95a"..lvl_e_c.."/"..e_rq,false,x_l_l-14,player.pos.y)
		end
...
function move_control(ntt)
	...
	if ntt.ts.hitshock < 3 then
		...
		if #ntt.m_l_arms > 0 then
			...
			local input_dir_h = input_dir_l + vec2_right*(tonum_flip(not ntt.is_left))*0.05
			
			local hold_pos,throw_str = ntt.pos + vec2_norm(input_dir_h)*ntt.arm_len,1.6
		...
		if ntt.b4 and jump_cooldown <= 0 then
			...
			if ntt.g_mode and g_is_ntt and not g_e.d_i then
			...
			elseif ntt.g_mode and vec2_dot(ntt.vel,surface_normal) > -4.5 or ntt.flying then
...
function Uply(pl) -- todo remove arg?
	...
	if ((btnp(5) or pl.in_burst) and not pl.in_grab and pl.gunid and timer_ready(pl, "gun")) fire_gun(pl)
...
gah! peer-to-peer interaction`-2`17`75`y_u_l/-32`62`17`8`4`35`7`8416`1`4832`5360`5056`1
...
`27`12`86`e_rq/1`122`12`6`4`49`51`8304`0`4712`5472`5184`2
1: elevatorspace`28`3`273`e_rq/4`13`12`11`10`49`3`8304`1`4968`4704`5312`4
2: the garages`29`5`81`y_u_l,e_rq/-128,3`89`24`9`12`49`3`8304`0`4712`5472`5440`3
3: `30`3`112`/`35`12`13`6`49`7`8304`0`4712`4704`5204`3
4: `31`12`114`y_u_l/-16`56`12`31`5`49`7`8304`0`4712`5600`5568`1
5: `-1`12`181`sl_l,sl_c,y_u_l,sl_vy,x_l_l,e_rq,sl_smth/197,1,-64,-0.75,448,3,0.83`51`17`11`7`49`7`8304`0`4712`5472`5572`4
         `33`71`174`y_l_l/280`85`17`18`7`57`39`8432`0`5096`5240`5328`4
`34`6`240`grav/0.19,0.18`36`22`11`9`57`39`8432`0`5096`4832`5420`5
`35`57`-12`grav,y_u_l,y_l_l,e_rq/0.19,-96,2,190`49`12`7`3`57`39`8560`0`5224`4832`5452`2
`36`4`170`grav,y_u_l,e_rq/0.19,-64,3`0`22`16`6`57`39`8560`0`5352`5480`5548`5
`37`4`138`grav,x_u_l,x_l_l/0.19,-64,320`16`22`8`6`57`39`8560`0`5480`4968`4520`1
...
0, 3,  0.1,240|coll_func,item,amount,smok,ignS,g_i/_V_Citm,1,25,2,true,true
...
11,4,0.2,247|item,f_c,f_l/2,3,6
...
11, 3,  0.1,242|item,outl/3,12]],"\n")



-- modifications for certain entities in level, no newlines to keep control chars (made in lvl editor)
ntt_extrainfos=split("/⬅️p_a/true⬅️next_e/11⬅️rX,rY/20,0⬅️rX,rY/-20,0⬅️rX,rY/0,-20⬅️rX,rY/-16,-16⬅️Btyp,permastick,rope,ai_a,rngN,rngF/5,true,nil,_V_AIAfllw,35,70⬅️gunid/9⬅️boss/true⬅️rope,rX,rY/1,76,-20⬅️b_f/_V_d_load_next⬅️is_left/t⬅️is_up/t⬅️is_left,is_up/t,t⬅️rX,rY/-16,16⬅️txtB/\-f\^h\fadanger!\n\nrogue\nmachinery\nahead ->⬇️false⬇️386⬇️-30⬇️44⬇️42⬇️2⬇️1⬅️rope,rX,rY,rope_e/1,-45,-8,len➡️50⬅️txtB/\f3looks like⬇️false⬇️90⬇️102⬇️98⬇️32⬇️8⬇️1⬅️txtB/\fastaff is advised\n to only \fcgrab the\nheat-seeking bolts\fa\nin emergencies⬇️false⬇️36⬇️40⬇️94⬇️32⬇️2⬇️1⬅️decal/\f2\^o0ff🅾️\-2\|9\f2\^o0dbj\|fum\|fp!\*f \*f \*f \*5 \^h\n🅾️\n\n\|c \-e+\n\n\|c\-f\^:10387c1010100010⬅️decal/\f2\^o0ff\^:00008064320f0204 \^h ❎\|e\n\ng\|fr\|fa\|fb  \|e\^:0000070c90a0c0f0⬅️decal/\f2\^o0ffk\|ee\|fep\n\n\|eg\|fo\|fi\|fng\^;10387c1010100010⬅️actF/600⬅️actF,rngF,rngN,ai_a/600,160,25,_V_AIAfllw⬅️gunid/29⬅️enemy/nil⬅️enemy/true⬅️gunid/15⬅️next_e/39⬅️actF,enemy/600,nil","⬅️")
...
prop_mods = split([[/
rngF,rngN/90,45
rngF,rngN,ai_a,hz/60,40,_V_AIAfllw,nil
rngF,rngN,flying/60,40,true
rngF,rngN/1,0
...
kb/0.7
rngF,rngN,hz,ai_a/3,0,t,_V_AIAhvr
dur,smok,kb,Cdmg/2,nil,0.04,12]],"\n")
...

...
b152d401c152231002c5e2100254d2309141c11091c3c11070f2a5b1d16208b1b0d254c1d0d2343162437210e0211142296060606018586f6f6f6f6f6f826a62
...
a03204f88970108750c110e67081d8b918a00cd0f0b1103206080a462008412110e1528008c890b07ab181100000000000000000000000005000307000209000
...

...
31d0811012f2d430f134c2303181f0a17251d4100000000000000000000000000510588805870808000008080808080800000808080808080000080808080808
...

__label__
...

...

...

...

__sfx__
