...
function begin_lvl(cont,retry)
	...
	-- lvl var defaults
	mod_tabl(_ENV,"aC,lvl_enms,lvl_e_clear,lvl_e_req,x_u_l,y_u_l,trn_bnc,trn_slp,grav,lvl_tr_collected,lvl_trinkets,sludg_l,sl_c,sl_smth,sl_vx,sl_vy,sl_dmg,alert,l_t_c,sl_r,sl_h,sl_spd,wind/1,0,0,0,0,0,0.2,0.75,0.216,0,0,1024,6,0.9,0,-0.16,0,false,0,0,0.04,5,0")
...
function move_humanoid(entity)
	...
	envstr.mod_tabl(entity, "sSt,g_mode,jump_g,g_no_slide,slide/false") -- implicit nil chain
...
lvls_info_2 = split([[   the construction site  `2`24`26`y_u_l/-32`0`33`23`3`6`1`8272`1`4832`5216`4608`5
...
1: what a blast`9`10`88`/`35`32`12`4`18`5`8528`1`4984`5112`5504`4
...
5: annoyingly out of reach`13`8`35`y_u_l,lvl_e_req/-96,1`79`21`11`4`18`13`8656`12`5240`5368`5024`2
...
`29`12`88`/`79`17`7`4`-1`48`8304`0`4712`5472`5184`0
...
4: `33`12`114`y_u_l/-16`0`31`32`5`49`7`8304`0`4712`5600`5568`1
...
`39`4`204`grav/0.19`0`23`16`8`57`39`8560`0`5352`5480`5256`6
